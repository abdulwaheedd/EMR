...
namespace EMR.Medadmins.Entities
{
    ...
    public sealed class MedadministrationRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Medicine "),NotNull, Column("OrderId"), ForeignKey("[dbo].[VisitsMedicine]", "OrderId"),LookupInclude, LeftJoin("jMedicine")]
        ...
        [DisplayName("Order Datae (s)"), Size(50), NotNull]
        ...
        [DisplayName("Admin Date (s)"), Size(50)]
