...
namespace EMR.Medadmins.Entities
{
    ...
    [ConnectionKey("Default"), Module("Medadmins"), TableName("[dbo].[MedPatients]")]
    [DisplayName("Nursing page"), InstanceName("Nursing")]
    [ReadPermission(PermissionKeys.Medadminpatients.View)]
    [ModifyPermission(PermissionKeys.Medadminpatients.Update)]
    [InsertPermission(PermissionKeys.Medadminpatients.Insert)]
    [DeletePermission(PermissionKeys.Medadminpatients.Delete)]
    public sealed class MedadminpatientsRow : Row, IIdRow, INameRow
    {
