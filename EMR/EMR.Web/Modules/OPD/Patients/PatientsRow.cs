...
namespace EMR.OPD.Entities
{
    ...
    [ConnectionKey("Default"), Module("OPD"), TableName("[dbo].[Outpatients]")]
    [DisplayName("Patients"), InstanceName("Patients")]
    [ReadPermission(PermissionKeys.Patients.View)]
    [ModifyPermission(PermissionKeys.Patients.Update)]
    [InsertPermission(PermissionKeys.Patients.Insert)]
    [DeletePermission(PermissionKeys.Patients.Delete)]
    [LookupScript("Configs.Outpatients")]
