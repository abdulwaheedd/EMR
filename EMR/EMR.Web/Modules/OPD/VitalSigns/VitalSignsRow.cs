...
namespace EMR.OPD.Entities
{
    ...
    [ConnectionKey("Default"), Module("OPD"), TableName("[dbo].[VitalSigns]")]
    [DisplayName("Vital Signs"), InstanceName("Vital Sign")]
    [ReadPermission(PermissionKeys.VitalSigns.View)]
    [ModifyPermission(PermissionKeys.VitalSigns.Update)]
    [InsertPermission(PermissionKeys.VitalSigns.Insert)]
    [DeletePermission(PermissionKeys.VitalSigns.Delete)]
    public sealed class VitalSignsRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Blood Pressure"), Column("BP"),NotNull, Size(50), QuickSearch]
        public String Bp
        {
