...
namespace EMR.OPD.Entities
{
    ...
    [ConnectionKey("Default"), Module("OPD"), TableName("[dbo].[Prescriptions]")]
    [DisplayName("Prescriptions"), InstanceName("Prescription")]
    [ReadPermission(PermissionKeys.Prescriptions.View)]
    [ModifyPermission(PermissionKeys.Prescriptions.Update)]
    [InsertPermission(PermissionKeys.Prescriptions.Insert)]
    [DeletePermission(PermissionKeys.Prescriptions.Delete)]
    public sealed class PrescriptionsRow : Row, IIdRow, INameRow
    {
