...
namespace EMR.OPD.Entities
{
    ...
    [ConnectionKey("Default"), Module("OPD"), TableName("[dbo].[Visits]")]
    [DisplayName("Visits"), InstanceName("Visit")]
    [ReadPermission(PermissionKeys.Visits.View)]
    [ModifyPermission(PermissionKeys.Visits.Update)]
    [InsertPermission(PermissionKeys.Visits.Insert)]
    [DeletePermission(PermissionKeys.Visits.Delete)]
    public sealed class VisitsRow : Row, IIdRow, INameRow
    {
