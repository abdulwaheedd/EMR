...
namespace EMR.Pharmacy.Entities
{
    ...
    [ConnectionKey("Default"), Module("Pharmacy"), TableName("[dbo].[Medvisits]")]
    [DisplayName("Medvisits"), InstanceName("Medvisits")]
    [ReadPermission(PermissionKeys.Medvisits.View)]
    [ModifyPermission(PermissionKeys.Medvisits.Update)]
    [InsertPermission(PermissionKeys.Medvisits.Insert)]
    [DeletePermission(PermissionKeys.Medvisits.Delete)]
    public sealed class MedvisitsRow : Row, IIdRow, INameRow
    {
