...
namespace EMR.Pharmacy.Entities
{
    ...
    [ConnectionKey("Default"), Module("Pharmacy"), TableName("[dbo].[MedPatients]")]
    [DisplayName("Prescriptions"), InstanceName("Prescription")]
    [ReadPermission(PermissionKeys.MedPatients.View)]
    [ModifyPermission(PermissionKeys.MedPatients.Update)]
    [InsertPermission(PermissionKeys.MedPatients.Insert)]
    [DeletePermission(PermissionKeys.MedPatients.Delete)]
    public sealed class MedPatientsRow : Row, IIdRow, INameRow
    {
