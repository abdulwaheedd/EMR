...
namespace EMR.Regs {
    ...
    import fld = TblNewBornManagementRow.Fields;

    @Serenity.Decorators.registerClass()
    export class AdmissionsNewBornManagementGrid extends TblNewBornManagementGrid {
        protected getDialogType() { return AdmissionsNewBornManagementDialog; }
