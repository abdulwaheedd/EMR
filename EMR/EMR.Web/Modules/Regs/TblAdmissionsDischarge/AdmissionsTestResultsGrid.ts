...
namespace EMR.Regs {
    ...
    import fld = TblTestExaminationsRow.Fields;

    @Serenity.Decorators.registerClass()
    export class AdmissionsTestResultsGrid extends TblTestExaminationsGrid {
        protected getDialogType() { return AdmissionsTestResultsDialog; }
