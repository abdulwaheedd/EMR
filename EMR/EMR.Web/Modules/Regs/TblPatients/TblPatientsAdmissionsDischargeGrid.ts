...
namespace EMR.Regs {
    ...
    import fld = TblAdmissionsDischargeRow.Fields;

    @Serenity.Decorators.registerClass()
    export class TblPatientsAdmissionsDischargeGrid extends TblAdmissionsDischargeGrid {
        protected getDialogType() { return TblPatientsAdmissionsDischargeDialog; }
