...
namespace EMR.VitalSigns.Entities
{
    ...
    [ConnectionKey("Default"), Module("VitalSigns"), TableName("[dbo].[VitalPatients]")]
    [DisplayName("Vital Patients"), InstanceName("Vital Patients")]
    [ReadPermission(PermissionKeys.VitalPatients.View)]
    [ModifyPermission(PermissionKeys.VitalPatients.Update)]
    [InsertPermission(PermissionKeys.VitalPatients.Insert)]
    [DeletePermission(PermissionKeys.VitalPatients.Delete)]
    public sealed class VitalPatientsRow : Row, IIdRow, INameRow
    {
