...
namespace EMR.VitalSigns.Entities
{
    ...
    [ConnectionKey("Default"), Module("VitalSigns"), TableName("[dbo].[Vitalvisits]")]
    [DisplayName("Vital Visits"), InstanceName("Visit")]
    [ReadPermission(PermissionKeys.Vitalvisits.View)]
    [ModifyPermission(PermissionKeys.Vitalvisits.Update)]
    [InsertPermission(PermissionKeys.Vitalvisits.Insert)]
    [DeletePermission(PermissionKeys.Vitalvisits.Delete)]
    public sealed class VitalvisitsRow : Row, IIdRow, INameRow
    {
