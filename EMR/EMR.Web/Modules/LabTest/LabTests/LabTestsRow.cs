...
namespace EMR.LabTest.Entities
{
    ...
    [ConnectionKey("Default"), Module("LabTest"), TableName("[dbo].[LabTest]")]
    [DisplayName("Lab Tests"), InstanceName("Lab Tests")]
    [ReadPermission(PermissionKeys.LabTests.View)]
    [ModifyPermission(PermissionKeys.LabTests.Update)]
    [InsertPermission(PermissionKeys.LabTests.Insert)]
    [DeletePermission(PermissionKeys.LabTests.Delete)]
    public sealed class LabTestsRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Result"), Size(200), QuickSearch, NotNull]
        ...
        [DisplayName("Test Date (Shamsi)"),NotNull]
