...
namespace EMR.LabTest.Entities
{
    ...
    [ConnectionKey("Default"), Module("LabTest"), TableName("[dbo].[Labvisits]")]
    [DisplayName("Labvisits"), InstanceName("Labvisits")]
    [ReadPermission(PermissionKeys.Labvisits.View)]
    [ModifyPermission(PermissionKeys.Labvisits.Update)]
    [InsertPermission(PermissionKeys.Labvisits.Insert)]
    [DeletePermission(PermissionKeys.Labvisits.Delete)]
    public sealed class LabvisitsRow : Row, IIdRow, INameRow
    {
