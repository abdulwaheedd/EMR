...
namespace EMR.Register.Entities
{
    ...
    [ConnectionKey("Default"), Module("Register"), TableName("[dbo].[Regoutpatients]")]
    [DisplayName("Patient"), InstanceName("Patient")]
    [ReadPermission(PermissionKeys.Regoutpatients.View)]
    [ModifyPermission(PermissionKeys.Regoutpatients.Update)]
    [InsertPermission(PermissionKeys.Regoutpatients.Insert)]
    [DeletePermission(PermissionKeys.Regoutpatients.Delete)]
    public sealed class RegoutpatientsRow : Row, IIdRow, INameRow
    {
