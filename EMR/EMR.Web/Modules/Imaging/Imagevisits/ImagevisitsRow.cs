...
namespace EMR.Imaging.Entities
{
    ...
    [ConnectionKey("Default"), Module("Imaging"), TableName("[dbo].[Imagevisits]")]
    [DisplayName("Imagevisits"), InstanceName("Imagevisits")]
    [ReadPermission(PermissionKeys.Imagevisits.View)]
    [ModifyPermission(PermissionKeys.Imagevisits.Update)]
    [InsertPermission(PermissionKeys.Imagevisits.Insert)]
    [DeletePermission(PermissionKeys.Imagevisits.Delete)]
    public sealed class ImagevisitsRow : Row, IIdRow, INameRow
    {
