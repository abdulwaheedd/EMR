...
namespace EMR.Imaging.Entities
{
    ...
    [ConnectionKey("Default"), Module("Imaging"), TableName("[dbo].[ImagePatients]")]
    [DisplayName("Image Patients"), InstanceName("Image Patients")]
    [ReadPermission(PermissionKeys.ImagePatients.View)]
    [ModifyPermission(PermissionKeys.ImagePatients.Update)]
    [InsertPermission(PermissionKeys.ImagePatients.Insert)]
    [DeletePermission(PermissionKeys.ImagePatients.Delete)]
    public sealed class ImagePatientsRow : Row, IIdRow, INameRow
    {
