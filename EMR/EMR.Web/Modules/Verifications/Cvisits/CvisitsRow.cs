...
namespace EMR.Verifications.Entities
{
    ...
    [ConnectionKey("Default"), Module("Verifications"), TableName("[dbo].[Cvisits]")]
    [DisplayName("Visits"), InstanceName("Visit")]
    [ReadPermission(PermissionKeys.Cvisits.View)]
    public sealed class CvisitsRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("DateOfVisit"),QuickSearch]
