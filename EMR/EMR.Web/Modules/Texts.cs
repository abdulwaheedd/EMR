    ...
    public static partial class Texts
    {
        public static class Db
        {
            public static class Administration
            {
                public static class Translation
                {
                    ...
                    public static LocalText AdmissionDateBigger = "Admission date cannot be bigger than today! Please correct it";
                    public static LocalText AdmissionDateSmaller = "The admission date is too early to enter. Pleae enter a valid date";
                    public static LocalText DischargeDateInvalid = "Discharge date is not valid. Please review admission date and correct it";
                    public static LocalText DischargeDateEqualToday = "Discharge date should be less than or equal to today! Please correct it.";
                    public static LocalText DischargeLessThanAdmission = "Discharge date cannot be less than admission date! Please correct it.";
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your EMR Password";
                ...
                {
                    public static LocalText FormTitle = "Electronic Medical Record (EMR)";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your EMR Account";
                    ...
                    public static LocalText FormTitle = "Sign up for EMR";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "EMR";
        }
        ...
        public static class Site
        {
            ...
            public static class Layout
            {
                ...
                public static LocalText FooterOwner = "@ Ministry of Public Health ";
                public static LocalText FooterInfo = "E-Medical Record";
